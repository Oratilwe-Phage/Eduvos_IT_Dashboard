...
#Downloading the cleaned data on my device: 
write.csv(data_clean, "/Users/oratilwephage/Documents/ITRDA3-B11/Assignment/Dataset/data_clean.csv", row.names = FALSE)
